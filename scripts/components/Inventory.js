...
const ref = new Firebase('https://catch-of-the-day-chad.firebaseio.com');
...
class Inventory extends React.Component {
  ...
  authHandler(err, authData) {
    ...
    //  Save login auth token in the browser
    ...
    storeRef.on('value', (snapshot) => {
      ...
      //  Claim store as our own if there is not already an owner
      if (!data.owner) {
        storeRef.set({
          owner: authData.uid
        });
